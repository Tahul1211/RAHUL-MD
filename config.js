...
MODERATORS : process.env.MODERATORS === undefined ? "919547261290,919083366564" : process.env.MODERATORS ,
...
HEROKU_APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'RAHUL-MD' : process.env.HEROKU_APP_NAME,
...
INBOX_USER: process.env.INBOX_USER === undefined ? '919547261290' : process.env.INBOX_USER,
BANNED_USER: process.env.BANNED_USER === undefined ? '919083366564' : process.env.BANNED_USER ,
