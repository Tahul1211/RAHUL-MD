...
MODERATORS : process.env.MODERATORS === undefined ? "919547261290" : process.env.MODERATORS ,
SESSION_ID : process.env.SESSION_ID === undefined ? 'RAHUL-MD~NIpzlQjC#YVFFiJQfE37P6FTNaZrJDOXAQ-Iga3R6y91kME1OFyw' : process.env.SESSION_ID,
...
HEROKU_APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'RAHUL' : process.env.HEROKU_APP_NAME,
